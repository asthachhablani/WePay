...
function LoanCalculator({ token, isAdmin, hasActiveLoan, navigate }) {
  ...
  const totalInterest = amount * (dailyInterestRate / 100) * duration;
    ...
    <div className="calculator-box">
      ...
      <div className="calculator-controls">
        <div className="calculator-intro">
          <span>ESTIMATE YOUR REPAYMENT</span>
        ...
        <div className="fixed-rate">
          ...
          <div>
            ...
            <span>{dailyInterestRate}% per day</span>
          </div>
      ...
      <div className="calculator-result">
        <div className="result-label">YOUR ESTIMATE</div>

        <h3>₹{formatMoney(amount)}</h3>

        <p className="result-subtitle">You could borrow</p>
        ...
        <div className="result-details">
          ...
          <div>
            ...
            <strong>{dailyInterestRate}% / day</strong>
          </div>
        ...
        <small className="calculator-note">
          Estimate based on the selected amount, duration and fixed interest
          rate.
        </small>
      </div>
    </div>
...
function Home() {
      ...
      try {
        ...
        if (response.ok && data.loans?.length > 0) {
          const activeLoan = data.loans.some((loan) =>
            ["pending", "approved", "active", "overdue"].includes(loan.status),
          );
  ...
  const renderMainButton = () => {
    if (!token) {
      return (
        <button className="new-primary-btn" onClick={() => navigate("/login")}>
          Get Started
          <span>↗</span>
        </button>
      );
  ...
  return (
    <div className="new-home">
      ...
      <nav className="new-navbar">
        ...
        <div className="new-logo" onClick={() => navigate("/")}>
      ...
      <section className="new-hero">
        ...
        <div className="hero-grid">
          <div className="new-hero-copy">
            ...
            <p>
              WePay makes borrowing simple, transparent and easier to understand
            ...
            <div className="hero-buttons">
              ...
              <a href="#why" className="hero-text-link">
                Discover WePay
                <span>↓</span>
              </a>
            </div>
      ...
      <section className="trust-strip">
        <div className="trust-strip-item">
          <div className="trust-strip-icon">✓</div>

          <div>
            <strong>Clear terms</strong>

            <span>Know before you apply</span>
          </div>
        </div>
        ...
        <div className="trust-strip-item">
          ...
          <div>
            <strong>Know your repayment</strong>

            <span>No guessing later</span>
          </div>
        </div>
        ...
        <div className="trust-strip-item">
          ...
          <div>
            ...
            <span>Apply in a few steps</span>
          </div>
        </div>
      </section>
      ...
      <section className="new-trust" id="trust">
        ...
        <div className="trust-number">
          <small>BUILT FOR SIMPLE BORROWING</small>

          <div>
            0.5<sup>%</sup>
          </div>

          <span>fixed daily interest rate</span>
        </div>

        <div className="trust-text">
          <span className="section-tag">KNOW YOUR NUMBERS</span>
          ...
          <p>
            WePay keeps the important numbers clear — from the amount you borrow
            to the interest and total repayment.
          </p>
        </div>
      ...
      <section className="loan-preview" id="calculator">
        <div className="loan-preview-heading">
          <div>
            <span className="section-tag">PLAN BEFORE YOU BORROW</span>
          ...
          <p>
            Choose an amount and duration to get a quick, clear estimate of your
      ...
      <section className="new-why" id="why">
        <div className="why-intro">
          <div>
            <span className="section-tag">WHY WEPAY</span>
          ...
          <p>
            No complicated language. No unnecessary steps. Just a clearer way to
        ...
        <div className="why-cards">
          <article className="why-card">
            ...
            <p>
              See your important loan information before you make a decision.
            </p>
          ...
          <article className="why-card featured">
            ...
            <p>
              Understand fees, interest and repayment without digging through
              fine print.
            </p>
          ...
          <article className="why-card">
            ...
            <p>
              A borrowing experience designed to feel helpful, not overwhelming.
            </p>
      ...
      <section className="new-how" id="how">
        ...
        <div className="steps-wrapper">
          <div className="step-card">
            ...
            <p>Choose your amount, duration and purpose.</p>
          </div>
          ...
          <div className="step-card">
            ...
            <p>See your fees, amount received and total repayment.</p>
          </div>
          ...
          <div className="step-card">
            ...
            <p>Apply and manage everything through your dashboard.</p>
          </div>
        </div>
      </section>
      ...
      <section className="faq-section" id="faq">
        <div className="faq-heading">
          ...
          <p>A few things you might want to know before getting started.</p>
        </div>

        <div className="faq-list">
          <details className="faq-item">
            <summary>
              <span>How is the interest on my loan calculated?</span>
            ...
            <div className="faq-answer">
              <p>
                WePay currently uses a fixed daily interest rate of 0.5%. Your
                total interest depends on the amount you borrow and the number
                of days you choose.
              </p>
            </div>
          </details>
          ...
          <details className="faq-item">
            ...
            <div className="faq-answer">
              <p>
                Loan amounts currently range from ₹1,000 to ₹1,00,000, subject
                to the applicable loan terms.
              </p>
            </div>
          </details>
          ...
          <details className="faq-item">
            <summary>
              <span>How long can I take the loan for?</span>
            ...
            <div className="faq-answer">
              <p>
                You can currently choose a loan duration between 1 and 50 days.
              </p>
            </div>
          </details>
          ...
          <details className="faq-item">
            <summary>
              <span>Can I apply for another loan if I already have one?</span>
            ...
            <div className="faq-answer">
              <p>
                You can apply for another loan after your existing loan has been
                completed. An active, pending, approved or overdue loan prevents
                a new application.
              </p>
            </div>
          </details>
          ...
          <details className="faq-item">
            <summary>
              <span>Where can I track my loan?</span>
            ...
            <div className="faq-answer">
              <p>
                Once you're logged in, you can use your dashboard to view your
                loan information and track its status.
              </p>
            </div>
          </details>
        </div>
      ...
      <footer className="new-footer">
        ...
        <div className="footer-bottom">
          <span>© 2026 WePay. All rights reserved.</span>
